...
import static com.j2esus.lesson2.CyclicRotationV3.cyclicRotationArray;
import org.junit.Test;

public class CyclicRotationV3Test {
    ...
    @Test
    public void cyclicRotationArray_emptyArrayAndOneRotation_emptyArray() {
        int[] data = new int[]{};
        int numRotations = 1;
