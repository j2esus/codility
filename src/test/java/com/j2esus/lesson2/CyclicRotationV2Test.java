...
import static com.j2esus.lesson2.CyclicRotationV2.cyclicRotationArray;
import org.junit.Test;

public class CyclicRotationV2Test {
    ...
    @Test
    public void cyclicRotationArray_emptyArrayAndOneRotation_returnEmptyArray(){
        int[] data = new int[]{};
        int numRotations = 1;
